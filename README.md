...
### @version 2.0
	1、
		...
		b) 默认的URL拆分是取URL中path部分的最后两个路径，如“[http://localhost:3000/sasas/fasasdf/user/index](http://localhost:3000/sasas/fasasdf/user/index)”取user做控制器，
...
### The problems in the development:
	...
	5、 程序报：Can't set headers after they are sent  的错误
		...
		有外国朋友说这个是node core 的BUG。0.8的版本不会出现此问题（[The Wiki](https://github.com/joyent/node/wiki)
		[https://github.com/visionmedia/express/issues/751](https://github.com/visionmedia/express/issues/751)）。
